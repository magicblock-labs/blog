...
While Bolt isn't exclusively an Entity Component System (ECS) framework, we encourage the use of this powerful design pattern to enhance composability. ECS is a way of organizing code and data to enable modular and extendible games, one main benefit of fully onchain games. As the name suggests, in an ECS there are:  
